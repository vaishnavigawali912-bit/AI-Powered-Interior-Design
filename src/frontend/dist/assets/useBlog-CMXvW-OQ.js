...
const DEMO_POSTS = [
  {
    ...
    excerpt: "Discover how top US interior designers make small living rooms feel expansive, luxurious, and deeply personal — without blowing the budget.",
    category: "Design Ideas",
    featuredImageUrl: "/assets/generated/blog-1.dim_800x500.jpg",
    body: "",
    author: "Sophia Reeves",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 3),
    readTimeMinutes: 6n,
  ...
  },
  {
    ...
    excerpt: "NYC apartments are notoriously tiny. We interviewed 5 designers on how they create luxury living in under 400 sq ft — and the results are stunning.",
    category: "Studio Living",
    featuredImageUrl: "/assets/generated/blog-2.dim_800x500.jpg",
    body: "",
    author: "Marcus Laine",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 7),
    readTimeMinutes: 8n,
  ...
  },
  {
    ...
    excerpt: "Japandi — the Japanese-Scandinavian fusion — is the ultimate small-space design philosophy. Here's why it works and how to get the look.",
    category: "Design Styles",
    featuredImageUrl: "/assets/generated/blog-3.dim_800x500.jpg",
    body: "",
    author: "Yuki Tanaka",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 14),
    readTimeMinutes: 5n,
  ...
  },
  {
    ...
    excerpt: "Multi-functional, space-saving, and genuinely beautiful — we've curated the top furniture pieces for small US apartments this year.",
    category: "Shopping Guides",
    featuredImageUrl: "/assets/generated/blog-1.dim_800x500.jpg",
    body: "",
    author: "Sophia Reeves",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 21),
    readTimeMinutes: 7n,
  ...
  },
  {
    ...
    excerpt: "From rugs and lighting to furniture arrangement, learn the interior design secrets to creating distinct zones in a single-room apartment.",
    category: "Studio Living",
    featuredImageUrl: "/assets/generated/blog-2.dim_800x500.jpg",
    body: "",
    author: "Marcus Laine",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 28),
    readTimeMinutes: 6n,
  ...
  },
  {
    ...
    excerpt: "Paint choices can make or break a small room. We explore the proven palettes — from warm whites to deep moody hues — that create visual spaciousness.",
    category: "Color & Style",
    featuredImageUrl: "/assets/generated/blog-3.dim_800x500.jpg",
    body: "",
    author: "Yuki Tanaka",
    publishedAt: BigInt(Date.now() - 1e3 * 60 * 60 * 24 * 35),
    readTimeMinutes: 4n,
    tags: ["color", "paint", "small rooms", "design tips"]
  }
];
function useFeaturedBlogPosts(limit = 3) {
  return useQuery({
...
function useRelatedBlogPosts(category, excludeId, limit = 3) {
  return useQuery({
    queryKey: ["blog", "related", category, excludeId.toString(), limit],
    queryFn: async () => DEMO_POSTS.filter(
...
export {
  ...
  useBlogPostBySlug as a,
  useRelatedBlogPosts as b,
  useFeaturedBlogPosts as u
};
